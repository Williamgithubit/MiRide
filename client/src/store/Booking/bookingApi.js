...
export const bookingApi = createApi({
    ...
    endpoints: (builder) => ({
        ...
        getActiveBooking: builder.query({
        ...
        requestModification: builder.mutation({
        ...
        reportBookingIssue: builder.mutation({
...
export const { useGetCurrentBookingsQuery, useGetBookingHistoryQuery, useGetAllBookingsQuery, useGetBookingByIdQuery, useGetActiveBookingQuery, useGetBookingStatsQuery, useModifyBookingMutation, useCancelBookingMutation, useRequestModificationMutation, useGetBookingPaymentQuery, useExtendBookingMutation, useReportBookingIssueMutation, useGetBookingTimelineQuery, } = bookingApi;
