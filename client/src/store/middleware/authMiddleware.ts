import { Middleware, isRejectedWithValue, isRejected, isFulfilled } from '@reduxjs/toolkit';
...
// Helper to check if action is a plain object with a type and optional payload
interface Action {
  type: string;
  payload?: {
    request?: {
