        ...
        register: builder.mutation({
            query: (userData) => {
                ...
                if (userData.role === 'customer' && 'driverLicense' in userData) {
                    requestBody.driverLicense = userData.driverLicense;
                    if (userData.address)
                    ...
                    if (userData.businessAddress)
                        requestBody.businessAddress = userData.businessAddress;
                    if (userData.taxId)
                        requestBody.taxId = userData.taxId;
                    if (userData.businessPhone)
                        requestBody.businessPhone = userData.businessPhone;
                    if (userData.businessEmail)
                        requestBody.businessEmail = userData.businessEmail;
                }
